...
let rec member2 x = function
  | Empty -> false
  | Node(l, y, r) -> true || member2 x l || member2 x r
...
(* Torej gremo prvo na desno, potem pa vsak možen korak na levo. Ko ni možen noben korak več, zaključimo zadevo. *)
